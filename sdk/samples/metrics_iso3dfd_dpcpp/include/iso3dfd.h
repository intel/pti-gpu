...
bool Iso3dfdDevice(sycl::queue &q, float *ptr_next, float *ptr_prev, float *ptr_vel,
                   ...
                   size_t n2_block, size_t n3_block, size_t end_z, unsigned int num_iterations);

void PrintTargetInfo(sycl::queue &q, unsigned int dim_x, unsigned int dim_y);

void Usage(const std::string &program_name);

void PrintStats(double time, size_t n1, size_t n2, size_t n3, unsigned int num_iterations);

bool WithinEpsilon(float *output, float *reference, const size_t dim_x, const size_t dim_y,
                   const size_t dim_z, const unsigned int radius, const int zadjust,
                   const float delta);

bool CheckGridDimension(size_t n1, size_t n2, size_t n3, unsigned int dim_x, unsigned int dim_y,
