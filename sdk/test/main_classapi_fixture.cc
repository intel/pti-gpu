...
TEST_F(ClassApiFixtureTest, ValidateApiIdsNotChanged) {
  ...
  PTI_CHECK_SUCCESS(ptiViewGetApiIdName(pti_api_group_id::PTI_API_GROUP_SYCL, 265, &api_name));
  EXPECT_STREQ(api_name, "urUSMPoolSetInfoExp");
  PTI_CHECK_SUCCESS(ptiViewGetApiIdName(pti_api_group_id::PTI_API_GROUP_SYCL, 266, &api_name));
  EXPECT_STREQ(api_name, "urAdapterSetLoggerCallback");
  PTI_CHECK_SUCCESS(ptiViewGetApiIdName(pti_api_group_id::PTI_API_GROUP_SYCL, 267, &api_name));
  EXPECT_STREQ(api_name, "urAdapterSetLoggerCallbackLevel");
  PTI_CHECK_SUCCESS(ptiViewGetApiIdName(pti_api_group_id::PTI_API_GROUP_SYCL, 268, &api_name));
  EXPECT_STREQ(api_name, "urBindlessImagesGetImageUnsampledHandleSupportExp");
  PTI_CHECK_SUCCESS(ptiViewGetApiIdName(pti_api_group_id::PTI_API_GROUP_SYCL, 269, &api_name));
  EXPECT_STREQ(api_name, "urBindlessImagesGetImageSampledHandleSupportExp");
  PTI_CHECK_SUCCESS(ptiViewGetApiIdName(pti_api_group_id::PTI_API_GROUP_SYCL, 270, &api_name));
  EXPECT_STREQ(api_name, "urBindlessImagesGetImageMemoryHandleTypeSupportExp");
  ...
  PTI_CHECK_SUCCESS(ptiViewGetApiIdName(pti_api_group_id::PTI_API_GROUP_SYCL, 272, &api_name));
  EXPECT_STREQ(api_name, "urKernelSuggestMaxCooperativeGroupCount");
  PTI_CHECK_SUCCESS(ptiViewGetApiIdName(pti_api_group_id::PTI_API_GROUP_SYCL, 273, &api_name));
  EXPECT_STREQ(api_name, "urUSMContextMemcpyExp");
  PTI_CHECK_SUCCESS(ptiViewGetApiIdName(pti_api_group_id::PTI_API_GROUP_SYCL, 285, &api_name));
  EXPECT_STREQ(api_name, "urMemoryExportAllocExportableMemoryExp");
  PTI_CHECK_SUCCESS(ptiViewGetApiIdName(pti_api_group_id::PTI_API_GROUP_SYCL, 286, &api_name));
  EXPECT_STREQ(api_name, "urMemoryExportFreeExportableMemoryExp");
  PTI_CHECK_SUCCESS(ptiViewGetApiIdName(pti_api_group_id::PTI_API_GROUP_SYCL, 287, &api_name));
  EXPECT_STREQ(api_name, "urMemoryExportExportMemoryHandleExp");
  PTI_CHECK_SUCCESS(ptiViewGetApiIdName(pti_api_group_id::PTI_API_GROUP_SYCL, 288, &api_name));
  EXPECT_STREQ(api_name, "urBindlessImagesSupportsImportingHandleTypeExp");
  PTI_CHECK_SUCCESS(ptiViewGetApiIdName(pti_api_group_id::PTI_API_GROUP_SYCL, 289, &api_name));
  EXPECT_STREQ(api_name, "urIPCGetMemHandleExp");
  PTI_CHECK_SUCCESS(ptiViewGetApiIdName(pti_api_group_id::PTI_API_GROUP_SYCL, 290, &api_name));
  EXPECT_STREQ(api_name, "urIPCPutMemHandleExp");
  PTI_CHECK_SUCCESS(ptiViewGetApiIdName(pti_api_group_id::PTI_API_GROUP_SYCL, 291, &api_name));
  EXPECT_STREQ(api_name, "urIPCOpenMemHandleExp");
  PTI_CHECK_SUCCESS(ptiViewGetApiIdName(pti_api_group_id::PTI_API_GROUP_SYCL, 292, &api_name));
  EXPECT_STREQ(api_name, "urIPCCloseMemHandleExp");
  PTI_CHECK_SUCCESS(ptiViewGetApiIdName(pti_api_group_id::PTI_API_GROUP_SYCL, 293, &api_name));
  EXPECT_STREQ(api_name, "urDeviceWaitExp");
  PTI_CHECK_SUCCESS(ptiViewGetApiIdName(pti_api_group_id::PTI_API_GROUP_SYCL, 294, &api_name));
  EXPECT_STREQ(api_name, "urProgramDynamicLinkExp");
  PTI_CHECK_SUCCESS(ptiViewGetApiIdName(pti_api_group_id::PTI_API_GROUP_SYCL, 295, &api_name));
  EXPECT_STREQ(api_name, "urEnqueueKernelLaunchWithArgsExp");
  PTI_CHECK_SUCCESS(ptiViewGetApiIdName(pti_api_group_id::PTI_API_GROUP_SYCL, 296, &api_name));
  EXPECT_STREQ(api_name, "urGraphCreateExp");
  PTI_CHECK_SUCCESS(ptiViewGetApiIdName(pti_api_group_id::PTI_API_GROUP_SYCL, 297, &api_name));
  EXPECT_STREQ(api_name, "urQueueBeginGraphCaptureExp");
  PTI_CHECK_SUCCESS(ptiViewGetApiIdName(pti_api_group_id::PTI_API_GROUP_SYCL, 298, &api_name));
  EXPECT_STREQ(api_name, "urQueueBeginCaptureIntoGraphExp");
  PTI_CHECK_SUCCESS(ptiViewGetApiIdName(pti_api_group_id::PTI_API_GROUP_SYCL, 299, &api_name));
  EXPECT_STREQ(api_name, "urQueueEndGraphCaptureExp");
  PTI_CHECK_SUCCESS(ptiViewGetApiIdName(pti_api_group_id::PTI_API_GROUP_SYCL, 302, &api_name));
  EXPECT_STREQ(api_name, "urGraphDestroyExp");
  PTI_CHECK_SUCCESS(ptiViewGetApiIdName(pti_api_group_id::PTI_API_GROUP_SYCL, 303, &api_name));
  EXPECT_STREQ(api_name, "urGraphExecutableGraphDestroyExp");
  PTI_CHECK_SUCCESS(ptiViewGetApiIdName(pti_api_group_id::PTI_API_GROUP_SYCL, 304, &api_name));
  EXPECT_STREQ(api_name, "urQueueIsGraphCaptureEnabledExp");
  PTI_CHECK_SUCCESS(ptiViewGetApiIdName(pti_api_group_id::PTI_API_GROUP_SYCL, 305, &api_name));
  EXPECT_STREQ(api_name, "urGraphIsEmptyExp");
  PTI_CHECK_SUCCESS(ptiViewGetApiIdName(pti_api_group_id::PTI_API_GROUP_SYCL, 306, &api_name));
  EXPECT_STREQ(api_name, "urGraphDumpContentsExp");
  PTI_CHECK_SUCCESS(ptiViewGetApiIdName(pti_api_group_id::PTI_API_GROUP_SYCL, 307, &api_name));
  EXPECT_STREQ(api_name, "urGraphInstantiateGraphExp");
  PTI_CHECK_SUCCESS(ptiViewGetApiIdName(pti_api_group_id::PTI_API_GROUP_SYCL, 308, &api_name));
  EXPECT_STREQ(api_name, "urEnqueueGraphExp");
  PTI_CHECK_SUCCESS(ptiViewGetApiIdName(pti_api_group_id::PTI_API_GROUP_SYCL, 309, &api_name));
  EXPECT_STREQ(api_name, "urEnqueueHostTaskExp");
  PTI_CHECK_SUCCESS(ptiViewGetApiIdName(pti_api_group_id::PTI_API_GROUP_SYCL, 310, &api_name));
  EXPECT_STREQ(api_name, "urCommandBufferAppendKernelLaunchWithArgsExp");
  PTI_CHECK_SUCCESS(ptiViewGetApiIdName(pti_api_group_id::PTI_API_GROUP_SYCL, 311, &api_name));
  EXPECT_STREQ(api_name, "urKernelGetSuggestedLocalWorkSizeWithArgs");
  PTI_CHECK_SUCCESS(ptiViewGetApiIdName(pti_api_group_id::PTI_API_GROUP_SYCL, 312, &api_name));
  EXPECT_STREQ(api_name, "urUSMHostAllocRegisterExp");
  PTI_CHECK_SUCCESS(ptiViewGetApiIdName(pti_api_group_id::PTI_API_GROUP_SYCL, 313, &api_name));
  EXPECT_STREQ(api_name, "urUSMHostAllocUnregisterExp");
  PTI_CHECK_SUCCESS(ptiViewGetApiIdName(pti_api_group_id::PTI_API_GROUP_SYCL, 314, &api_name));
  EXPECT_STREQ(api_name, "urQueueGetGraphExp");
  PTI_CHECK_SUCCESS(ptiViewGetApiIdName(pti_api_group_id::PTI_API_GROUP_SYCL, 315, &api_name));
  EXPECT_STREQ(api_name, "urGraphSetDestructionCallbackExp");
  PTI_CHECK_SUCCESS(ptiViewGetApiIdName(pti_api_group_id::PTI_API_GROUP_SYCL, 316, &api_name));
  EXPECT_STREQ(api_name, "urIPCGetPhysMemHandleExp");
  PTI_CHECK_SUCCESS(ptiViewGetApiIdName(pti_api_group_id::PTI_API_GROUP_SYCL, 317, &api_name));
  EXPECT_STREQ(api_name, "urIPCPutPhysMemHandleExp");
  PTI_CHECK_SUCCESS(ptiViewGetApiIdName(pti_api_group_id::PTI_API_GROUP_SYCL, 318, &api_name));
  EXPECT_STREQ(api_name, "urIPCOpenPhysMemHandleExp");
  PTI_CHECK_SUCCESS(ptiViewGetApiIdName(pti_api_group_id::PTI_API_GROUP_SYCL, 319, &api_name));
  EXPECT_STREQ(api_name, "urIPCClosePhysMemHandleExp");
  PTI_CHECK_SUCCESS(ptiViewGetApiIdName(pti_api_group_id::PTI_API_GROUP_SYCL, 320, &api_name));
  EXPECT_STREQ(api_name, "urGraphGetNativeHandleExp");
  PTI_CHECK_SUCCESS(ptiViewGetApiIdName(pti_api_group_id::PTI_API_GROUP_SYCL, 321, &api_name));
  EXPECT_STREQ(api_name, "urGraphExecutableGraphGetNativeHandleExp");
  PTI_CHECK_SUCCESS(ptiViewGetApiIdName(pti_api_group_id::PTI_API_GROUP_SYCL, 322, &api_name));
  EXPECT_STREQ(api_name, "urEventCreateExp");
  PTI_CHECK_SUCCESS(ptiViewGetApiIdName(pti_api_group_id::PTI_API_GROUP_SYCL, 323, &api_name));
  EXPECT_STREQ(api_name, "urIPCGetEventHandleExp");
  PTI_CHECK_SUCCESS(ptiViewGetApiIdName(pti_api_group_id::PTI_API_GROUP_SYCL, 324, &api_name));
  EXPECT_STREQ(api_name, "urIPCPutEventHandleExp");
  PTI_CHECK_SUCCESS(ptiViewGetApiIdName(pti_api_group_id::PTI_API_GROUP_SYCL, 325, &api_name));
  EXPECT_STREQ(api_name, "urIPCOpenEventHandleExp");
  ...
  PTI_CHECK_SUCCESS(ptiViewGetApiIdName(pti_api_group_id::PTI_API_GROUP_LEVELZERO, 219, &api_name));
  EXPECT_STREQ(api_name, "zeDeviceGetRuntimeRequirements");
  PTI_CHECK_SUCCESS(ptiViewGetApiIdName(pti_api_group_id::PTI_API_GROUP_LEVELZERO, 220, &api_name));
  EXPECT_STREQ(api_name, "zeDeviceGetRuntimeRequirementsKey");
  PTI_CHECK_SUCCESS(ptiViewGetApiIdName(pti_api_group_id::PTI_API_GROUP_LEVELZERO, 221, &api_name));
  EXPECT_STREQ(api_name, "zeDeviceValidateRuntimeRequirements");
  PTI_CHECK_SUCCESS(ptiViewGetApiIdName(pti_api_group_id::PTI_API_GROUP_LEVELZERO, 222, &api_name));
  EXPECT_STREQ(api_name, "zeDeviceGetCounterBasedEventMaxValue");
  PTI_CHECK_SUCCESS(ptiViewGetApiIdName(pti_api_group_id::PTI_API_GROUP_LEVELZERO, 223, &api_name));
  EXPECT_STREQ(api_name, "zeCommandQueueGetFlags");
  PTI_CHECK_SUCCESS(ptiViewGetApiIdName(pti_api_group_id::PTI_API_GROUP_LEVELZERO, 224, &api_name));
  EXPECT_STREQ(api_name, "zeCommandQueueGetMode");
  PTI_CHECK_SUCCESS(ptiViewGetApiIdName(pti_api_group_id::PTI_API_GROUP_LEVELZERO, 225, &api_name));
  EXPECT_STREQ(api_name, "zeCommandQueueGetPriority");
  PTI_CHECK_SUCCESS(ptiViewGetApiIdName(pti_api_group_id::PTI_API_GROUP_LEVELZERO, 226, &api_name));
  EXPECT_STREQ(api_name, "zeCommandListAppendMemoryCopyWithParameters");
  PTI_CHECK_SUCCESS(ptiViewGetApiIdName(pti_api_group_id::PTI_API_GROUP_LEVELZERO, 227, &api_name));
  EXPECT_STREQ(api_name, "zeCommandListAppendMemoryFillWithParameters");
  PTI_CHECK_SUCCESS(ptiViewGetApiIdName(pti_api_group_id::PTI_API_GROUP_LEVELZERO, 228, &api_name));
  EXPECT_STREQ(api_name, "zeCommandListImmediateAppendCommandListsWithParameters");
  PTI_CHECK_SUCCESS(ptiViewGetApiIdName(pti_api_group_id::PTI_API_GROUP_LEVELZERO, 229, &api_name));
  EXPECT_STREQ(api_name, "zeCommandListGetFlags");
  PTI_CHECK_SUCCESS(ptiViewGetApiIdName(pti_api_group_id::PTI_API_GROUP_LEVELZERO, 230, &api_name));
  EXPECT_STREQ(api_name, "zeCommandListImmediateGetFlags");
  PTI_CHECK_SUCCESS(ptiViewGetApiIdName(pti_api_group_id::PTI_API_GROUP_LEVELZERO, 231, &api_name));
  EXPECT_STREQ(api_name, "zeCommandListImmediateGetMode");
  PTI_CHECK_SUCCESS(ptiViewGetApiIdName(pti_api_group_id::PTI_API_GROUP_LEVELZERO, 232, &api_name));
  EXPECT_STREQ(api_name, "zeCommandListImmediateGetPriority");
  PTI_CHECK_SUCCESS(ptiViewGetApiIdName(pti_api_group_id::PTI_API_GROUP_LEVELZERO, 233, &api_name));
  EXPECT_STREQ(api_name, "zeCommandListIsMutableExp");
  PTI_CHECK_SUCCESS(ptiViewGetApiIdName(pti_api_group_id::PTI_API_GROUP_LEVELZERO, 234, &api_name));
  EXPECT_STREQ(api_name, "zeCommandListBeginGraphCaptureExt");
  PTI_CHECK_SUCCESS(ptiViewGetApiIdName(pti_api_group_id::PTI_API_GROUP_LEVELZERO, 235, &api_name));
  EXPECT_STREQ(api_name, "zeCommandListBeginCaptureIntoGraphExt");
  PTI_CHECK_SUCCESS(ptiViewGetApiIdName(pti_api_group_id::PTI_API_GROUP_LEVELZERO, 236, &api_name));
  EXPECT_STREQ(api_name, "zeCommandListIsGraphCaptureEnabledExt");
  PTI_CHECK_SUCCESS(ptiViewGetApiIdName(pti_api_group_id::PTI_API_GROUP_LEVELZERO, 237, &api_name));
  EXPECT_STREQ(api_name, "zeCommandListEndGraphCaptureExt");
  PTI_CHECK_SUCCESS(ptiViewGetApiIdName(pti_api_group_id::PTI_API_GROUP_LEVELZERO, 238, &api_name));
  EXPECT_STREQ(api_name, "zeCommandListGetGraphExt");
  PTI_CHECK_SUCCESS(ptiViewGetApiIdName(pti_api_group_id::PTI_API_GROUP_LEVELZERO, 239, &api_name));
  EXPECT_STREQ(api_name, "zeCommandListAppendGraphExt");
  PTI_CHECK_SUCCESS(ptiViewGetApiIdName(pti_api_group_id::PTI_API_GROUP_LEVELZERO, 240, &api_name));
  EXPECT_STREQ(api_name, "zeCommandListAppendHostFunction");
  PTI_CHECK_SUCCESS(ptiViewGetApiIdName(pti_api_group_id::PTI_API_GROUP_LEVELZERO, 241, &api_name));
  EXPECT_STREQ(api_name, "zeEventGetCounterBasedFlags");
  PTI_CHECK_SUCCESS(ptiViewGetApiIdName(pti_api_group_id::PTI_API_GROUP_LEVELZERO, 242, &api_name));
  EXPECT_STREQ(api_name, "zeExecutableGraphGetSourceGraphExt");
  PTI_CHECK_SUCCESS(ptiViewGetApiIdName(pti_api_group_id::PTI_API_GROUP_LEVELZERO, 243, &api_name));
  EXPECT_STREQ(api_name, "zeExecutableGraphDestroyExt");
  PTI_CHECK_SUCCESS(ptiViewGetApiIdName(pti_api_group_id::PTI_API_GROUP_LEVELZERO, 244, &api_name));
  EXPECT_STREQ(api_name, "zeGraphCreateExt");
  PTI_CHECK_SUCCESS(ptiViewGetApiIdName(pti_api_group_id::PTI_API_GROUP_LEVELZERO, 245, &api_name));
  EXPECT_STREQ(api_name, "zeGraphGetPrimaryCommandListExt");
  PTI_CHECK_SUCCESS(ptiViewGetApiIdName(pti_api_group_id::PTI_API_GROUP_LEVELZERO, 246, &api_name));
  EXPECT_STREQ(api_name, "zeGraphSetDestructionCallbackExt");
  PTI_CHECK_SUCCESS(ptiViewGetApiIdName(pti_api_group_id::PTI_API_GROUP_LEVELZERO, 247, &api_name));
  EXPECT_STREQ(api_name, "zeGraphInstantiateExt");
  PTI_CHECK_SUCCESS(ptiViewGetApiIdName(pti_api_group_id::PTI_API_GROUP_LEVELZERO, 248, &api_name));
  EXPECT_STREQ(api_name, "zeGraphIsEmptyExt");
  PTI_CHECK_SUCCESS(ptiViewGetApiIdName(pti_api_group_id::PTI_API_GROUP_LEVELZERO, 249, &api_name));
  EXPECT_STREQ(api_name, "zeGraphDumpContentsExt");
  PTI_CHECK_SUCCESS(ptiViewGetApiIdName(pti_api_group_id::PTI_API_GROUP_LEVELZERO, 250, &api_name));
  EXPECT_STREQ(api_name, "zeGraphDestroyExt");
}
