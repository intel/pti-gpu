...
bool Is64BitCountersSupport(IGtKernelInstrument& instrumentor);
size_t GetCounterSizeBytes(IGtKernelInstrument& instrumentor);
GED_DATA_TYPE GetCounterDataType(IGtKernelInstrument& instrumentor);
GED_DATA_TYPE GetCounterDataTypeSigned(IGtKernelInstrument& instrumentor);
GtVregType GetCounterVregType(IGtKernelInstrument& instrumentor);
uint32_t GetNumTiles(IGtKernelInstrument& instrumentor);
...
GtReg GetSubReg(IGtKernelInstrument& instrumentor, size_t regNum, size_t subRegIdx,
                size_t subRegSizeBytes);
GtReg GetSubReg(size_t regNum, size_t subRegIdx, size_t subRegSizeBytes, size_t grfRegSize);

GtGenProcedure Mov(IGtKernelInstrument& instrumentor, const GtDstRegion& dst,
                   const GtRegRegion& src, GtExecMask execMask = EXEC_MASK_1_0,
                   GtPredicate predicate = GtPredicate::MakeNone());
GtGenProcedure Mov(IGtKernelInstrument& instrumentor, const GtDstRegion& dst, const GtImm& srcI,
                   GtExecMask execMask = EXEC_MASK_1_0,
                   GtPredicate predicate = GtPredicate::MakeNone());
GtGenProcedure Not(IGtKernelInstrument& instrumentor, const GtDstRegion& dst,
                   const GtRegRegion& src, GtExecMask execMask = EXEC_MASK_1_0,
                   GtPredicate predicate = GtPredicate::MakeNone());
GtGenProcedure Not(IGtKernelInstrument& instrumentor, const GtDstRegion& dst, const GtImm& srcI,
                   GtExecMask execMask = EXEC_MASK_1_0,
                   GtPredicate predicate = GtPredicate::MakeNone());
GtGenProcedure Cbit(IGtKernelInstrument& instrumentor, const GtDstRegion& dst,
                    const GtRegRegion& src, GtExecMask execMask = EXEC_MASK_1_0,
                    GtPredicate predicate = GtPredicate::MakeNone());
GtGenProcedure Cbit(IGtKernelInstrument& instrumentor, const GtDstRegion& dst, const GtImm& srcI,
                    GtExecMask execMask = EXEC_MASK_1_0,
                    GtPredicate predicate = GtPredicate::MakeNone());
GtGenProcedure Add(IGtKernelInstrument& instrumentor, const GtDstRegion& dst,
...
GtGenProcedure Add(IGtKernelInstrument& instrumentor, const GtDstRegion& dst,
                   ...
                   GtPredicate predicate = GtPredicate::MakeNone());
GtGenProcedure Addc(IGtKernelInstrument& instrumentor, const GtDstRegion& dst,
                    const GtRegRegion& src0, const GtRegRegion& src1,
                    GtExecMask execMask = EXEC_MASK_1_0,
                    GtPredicate predicate = GtPredicate::MakeNone());
GtGenProcedure Addc(IGtKernelInstrument& instrumentor, const GtDstRegion& dst,
                    ...
                    GtExecMask execMask = EXEC_MASK_1_0,
                    GtPredicate predicate = GtPredicate::MakeNone());
GtGenProcedure And(IGtKernelInstrument& instrumentor, const GtDstRegion& dst,
                   const GtRegRegion& src0, const GtRegRegion& src1,
                   GtExecMask execMask = EXEC_MASK_1_0,
                   GtPredicate predicate = GtPredicate::MakeNone());
GtGenProcedure And(IGtKernelInstrument& instrumentor, const GtDstRegion& dst,
                   const GtRegRegion& src0, const GtImm& srcI1, GtExecMask execMask = EXEC_MASK_1_0,
                   GtPredicate predicate = GtPredicate::MakeNone());
GtGenProcedure Or(IGtKernelInstrument& instrumentor, const GtDstRegion& dst,
                  const GtRegRegion& src0, const GtRegRegion& src1,
                  GtExecMask execMask = EXEC_MASK_1_0,
                  GtPredicate predicate = GtPredicate::MakeNone());
GtGenProcedure Or(IGtKernelInstrument& instrumentor, const GtDstRegion& dst,
                  const GtRegRegion& src0, const GtImm& srcI1, GtExecMask execMask = EXEC_MASK_1_0,
                  GtPredicate predicate = GtPredicate::MakeNone());
GtGenProcedure Xor(IGtKernelInstrument& instrumentor, const GtDstRegion& dst,
                   const GtRegRegion& src0, const GtRegRegion& src1,
                   GtExecMask execMask = EXEC_MASK_1_0,
                   GtPredicate predicate = GtPredicate::MakeNone());
GtGenProcedure Xor(IGtKernelInstrument& instrumentor, const GtDstRegion& dst,
                   const GtRegRegion& src0, const GtImm& srcI1, GtExecMask execMask = EXEC_MASK_1_0,
                   GtPredicate predicate = GtPredicate::MakeNone());
GtGenProcedure Shr(IGtKernelInstrument& instrumentor, const GtDstRegion& dst,
                   const GtRegRegion& src0, const GtRegRegion& src1,
                   GtExecMask execMask = EXEC_MASK_1_0,
                   GtPredicate predicate = GtPredicate::MakeNone());
GtGenProcedure Shr(IGtKernelInstrument& instrumentor, const GtDstRegion& dst,
                   const GtRegRegion& src0, const GtImm& srcI1, GtExecMask execMask = EXEC_MASK_1_0,
                   GtPredicate predicate = GtPredicate::MakeNone());
GtGenProcedure Shl(IGtKernelInstrument& instrumentor, const GtDstRegion& dst,
                   const GtRegRegion& src0, const GtRegRegion& src1,
                   GtExecMask execMask = EXEC_MASK_1_0,
                   GtPredicate predicate = GtPredicate::MakeNone());
GtGenProcedure Shl(IGtKernelInstrument& instrumentor, const GtDstRegion& dst,
                   const GtRegRegion& src0, const GtImm& srcI1, GtExecMask execMask = EXEC_MASK_1_0,
                   GtPredicate predicate = GtPredicate::MakeNone());
GtGenProcedure Mul(IGtKernelInstrument& instrumentor, const GtDstRegion& dst,
                   const GtRegRegion& src0, const GtRegRegion& src1,
                   GtExecMask execMask = EXEC_MASK_1_0,
                   GtPredicate predicate = GtPredicate::MakeNone());
GtGenProcedure Mul(IGtKernelInstrument& instrumentor, const GtDstRegion& dst,
                   const GtRegRegion& src0, const GtImm& srcI1, GtExecMask execMask = EXEC_MASK_1_0,
                   GtPredicate predicate = GtPredicate::MakeNone());
GtGenProcedure Sel(IGtKernelInstrument& instrumentor, const GtDstRegion& dst,
                   const GtRegRegion& src0, const GtRegRegion& src1,
                   GtExecMask execMask = EXEC_MASK_1_0,
                   GtPredicate predicate = GtPredicate::MakeNone());
GtGenProcedure Sel(IGtKernelInstrument& instrumentor, const GtDstRegion& dst,
                   const GtRegRegion& src0, const GtImm& srcI1, GtExecMask execMask = EXEC_MASK_1_0,
                   GtPredicate predicate = GtPredicate::MakeNone());
GtGenProcedure Sub(IGtKernelInstrument& instrumentor, const GtDstRegion& dst,
                   const GtRegRegion& src0, const GtRegRegion& src1,
                   GtExecMask execMask = EXEC_MASK_1_0,
                   GtPredicate predicate = GtPredicate::MakeNone());
GtGenProcedure Sub(IGtKernelInstrument& instrumentor, const GtDstRegion& dst,
...
GtGenProcedure Cmp(IGtKernelInstrument& instrumentor, GtCondModifier cond, GtReg flagReg,
                   const GtRegRegion& src0, const GtRegRegion& src1,
                   GtExecMask execMask = EXEC_MASK_1_0,
                   GtPredicate predicate = GtPredicate::MakeNone());
GtGenProcedure Cmp(IGtKernelInstrument& instrumentor, GtCondModifier cond, GtReg flagReg,
...
GtGenProcedure AtomicStore(IGtKernelInstrument& instrumentor, GtReg addrReg, GtReg dataReg,
                           GtExecMask execMask = EXEC_MASK_1_0,
                           GtPredicate predicate = GtPredicate::MakeNone());
...
namespace Procedure {
GtGenProcedure CounterInc(IGtKernelInstrument& instrumentor, GtProfileArray& profileArray,
...
GtGenProcedure CounterAdd(IGtKernelInstrument& instrumentor, GtProfileArray& profileArray,
...
GtGenProcedure AtomicStore(IGtKernelInstrument& instrumentor, GtProfileArray& profileArray,
                           GtReg baseAddrReg, GtReg tempAddrReg, GtReg dataReg,
                           uint64_t dataOffsetBytes, GtExecMask execMask = {1},
                           GtReg offsetBytesReg = NullReg(),
                           GtPredicate predicate = GtPredicate::MakeNone());

GtGenProcedure ComputeSimdMask(IGtKernelInstrument& instrumentor, GtReg simdMaskReg, bool maskCtrl,
                               uint32_t execMask, GtPredicate pred);
GtGenProcedure ComputeSimdMask(IGtKernelInstrument& instrumentor, GtReg simdMaskReg,
 ...
 */
GtGenProcedure IsCacheLineAligned(IGtKernelInstrument& instrumentor, GtReg addrRegCheckReg,
                                  size_t channelOffset, GtReg simdMaskReg, GtReg tempData1Reg,
                                  GtReg tempData2Reg, size_t mathWidthBytes = 2);
GtGenProcedure IsCacheLineAligned(IGtKernelInstrument& instrumentor, const IGtIns& gtpinIns,
 ...
 */
GtGenProcedure IsCacheLineAlignedFlag(IGtKernelInstrument& instrumentor, GtReg addrRegCheckReg,
                                      size_t channelOffset, GtReg simdMaskReg, GtReg tempData1Reg,
                                      GtReg flagReg = FlagReg(0));

GtGenProcedure IsCacheLineAlignedFlag(IGtKernelInstrument& instrumentor, const IGtIns& gtpinIns,
                                      GtReg simdMaskReg, GtReg tempData1Reg,
                                      GtReg flagReg = FlagReg(0));

GtGenProcedure CalcBaseAddr(IGtKernelInstrument& instrumentor, GtProfileArray& profileArray,
                            GtReg baseAddrReg, size_t recordIndex, size_t numTiles);

GtGenProcedure AdjustDistributionWithinBounds(IGtKernelInstrument& instrumentor, GtReg valueReg,
                                              size_t bucketsNum, GtReg flagReg = FlagReg(0));

GtGenProcedure CacheLinesCount(IGtKernelInstrument& instrumentor, GtReg clCounterReg,
