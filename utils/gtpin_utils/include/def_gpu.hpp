...
#define GTPIN_UTILS_MAX_SIMD_WIDTH_BYTES 4
#define GTPIN_UTILS_MAX_SIMD_WIDTH 8 * GTPIN_UTILS_MAX_SIMD_WIDTH_BYTES
#define GTPIN_UTILS_MAX_SIMD_WIDTH_STR STR(GTPIN_UTILS_MAX_SIMD_WIDTH)
