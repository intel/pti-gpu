...
GtGenProcedure Macro::Add(IGtKernelInstrument& instrumentor, const GtDstRegion& dst,
...
GtGenProcedure AddiXeHpc(IGtKernelInstrument& instrumentor, const GtDstRegion& dst,
